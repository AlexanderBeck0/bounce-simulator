        ...
        <div>
            <div className="flex flex-col">
                <div className="flex flex-nowrap items-center mb-4">
                    <div className="flex flex-1 space-x-2 basis-10/12">
                        ...
                        <select
                            className="select select-bordered flex flex-1 w-1/3"
                        ...
                        <input type="number" placeholder="Number of balls"
                            className="input input-bordered flex flex-initial w-1/6"
                    ...
                    <div className="flex-initial basis-2/12 w-1/5">
